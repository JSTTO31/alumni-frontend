...
const props = defineProps<{comment: Comment, reply: Reply}>()
...
const {execute, pending, status} = await $comment.reply_report(props.comment.id, props.reply.id, information)
const types = [
    "Spam",
    "Harassment",
    "Hate Speech",
