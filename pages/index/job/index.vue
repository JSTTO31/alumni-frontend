<template>
    <v-container>
        <v-row>
            <v-col cols="3">
                <div id="variation" class="pr-5" style="position: fixed;width: 270px;height: 80%;overflow-y: auto;">
                    <v-list class="bg-transparent">
                        ...
                        <div class="d-flex" style="gap: 10px">
                            <v-text-field type="number" variant="outlined" single-line hide-details density="compact"
            ...
            <v-col cols="9" class="pl-5">
                <job-list-item v-for="job, n in jobs" :key="job.title" :job="job" :index="n"
                    class="rounded-lg pa-8 mb-5">
