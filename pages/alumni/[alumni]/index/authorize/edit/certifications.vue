    ...
    <v-card class="rounded-lg py-3 px-4" :disabled="loading">
        <v-form @submit.prevent="save">
            ...
            <v-card-actions class="px-4">
                <v-btn class="text-capitalize px-6 text-error" prepend-icon="mdi-trash-can" variant="text" @click="$router.push({name: 'alumni-alumni-index-delete-certifications', query: {id: $route.query.id}})">Delete</v-btn>
                <v-spacer></v-spacer>
