            ...
            <v-card-text>
                <div class="d-flex" style="gap: 15px">
                    <div class="d-flex w-100 flex-column">
                        ...
                        <v-text-field :error-messages="$v.first_name.$errors[0]?.$message.toString() || ''"
                            v-model="$v.first_name.$model" class="mt-2" variant="outlined" density="compact"
                            label="First Name" single-line></v-text-field>
                    </div>
                    <div class="d-flex w-100 flex-column">
                        <label for="">Middle Name (Optional)</label>
                        <v-text-field v-model="$v.middle_name.$model" class="mt-2" variant="outlined" density="compact"
                ...
                <div class="d-flex flex-column">
                    ...
                    <v-text-field :error-messages="$v.last_name.$errors[0]?.$message.toString() || ''"
                        v-model="$v.last_name.$model" class="mt-2" variant="outlined" density="compact"
                        label="Last Name" single-line></v-text-field>
                </div>
                <div class="d-flex flex-column">
                    <label for="">Nationality (*)</label>
                    <v-select :error-messages="$v.nationality.$errors[0]?.$message.toString() || ''"
                        v-model="$v.nationality.$model" class="mt-2" variant="outlined" density="compact"
                ...
                <div class="d-flex" style="gap: 15px">
                    <div class="d-flex flex-column w-100">
                        ...
                        <v-select :error-messages="$v.gender.$errors[0]?.$message.toString() || ''"
                            ...
                            density="compact" label="Select gender" single-line></v-select>
                    </div>
                    <div class="d-flex flex-column w-100">
                        <label for="">Age (*)</label>
                        <v-text-field :error-messages="$v.age.$errors[0]?.$message.toString() || ''"
                            v-model="$v.age.$model" type="number" class="mt-2" variant="outlined" density="compact"
                ...
                <div class="d-flex flex-column">
                    ...
                    <v-select :error-messages="$v.civil_status.$errors[0]?.$message.toString() || ''"
                        ...
                        density="compact" label="Civil Status" single-line></v-select>
                </div>
                <div class="d-flex flex-column">
                    <label for="">Birthday (*)</label>
                    <v-text-field :error-messages="$v.birthday.$errors[0]?.$message.toString() || ''"
                        v-model="$v.birthday.$model" type="date" class="mt-2" variant="outlined" density="compact"
...
async function save() {
    ...
    $profile.editPersonalInformation(informations).then(() => {
        loading.value = false
        router.push({name: 'alumni-information'})
    })
}
</script>
