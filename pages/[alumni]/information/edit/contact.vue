        ...
        <v-form @submit.prevent="save">
            ...
            <v-card-text>
                ...
                <div class="d-flex w-100 flex-column">
                    ...
                    <v-text-field v-model="$v.facebook.$model" class="mt-2" variant="outlined" density="compact"
                        label="Facebook Link" single-line>
                    </v-text-field>
                    <label for="">Twitter link</label>
                    <v-text-field v-model="$v.twitter.$model" class="mt-2" variant="outlined" density="compact"
                        label="Twitter Link" single-line>
                    </v-text-field>
                    <label for="">Linkedin link</label>
                    <v-text-field v-model="$v.linkedin.$model" class="mt-2" variant="outlined" density="compact"
                        label="Linked Link" single-line>
                    </v-text-field>
                </div>
            </v-card-text>
            <v-divider></v-divider>
...
const informations = reactive({
    ...
    facebook: user.value?.contact_information.facebook,
    twitter: user.value?.contact_information.twitter,
    linkedin: user.value?.contact_information.linkedin,
})
